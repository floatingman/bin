...
from sabnzbd.misc import real_path, create_real_path, save_configfile, \
                         ...
                         decodePassword, encodePassword, create_api_key
...
def check_session(key):
    if sabnzbd.NO_API_KEY or key == sabnzbd.API_KEY:
        return None
    elif not key:
        return 'error: Session Key Required'
    else:
        return 'error: Session Key Incorrect'
...
class LoginPage:
    ...
    @cherrypy.expose
    def index(self, dummy=None, session=None):
        return ""
...
class MainPage(ProtectedClass):
    ...
    @cherrypy.expose
    def addID(self, id = None, pp=None, script=None, cat=None, redirect=None, session=None):
        msg = check_session(session)
        if msg: return msg
    ...
    @cherrypy.expose
    def addURL(self, url = None, pp=None, script=None, cat=None, redirect=None, session=None):
        msg = check_session(session)
        if msg: return msg
    ...
    @cherrypy.expose
    def addFile(self, nzbfile, pp=None, script=None, cat=None, dummy=None, session=None):
    ...
    @cherrypy.expose
    def pause(self, dummy=None, session=None):
        msg = check_session(session)
        if msg: return msg
    ...
    @cherrypy.expose
    def resume(self, dummy=None, session=None):
        msg = check_session(session)
        if msg: return msg
    ...
    @cherrypy.expose
    def rss(self, mode='history', session=None):
        if mode == 'history':
            return rss_history()
        elif mode == 'warnings':
            return rss_warnings()
    ...
    def api(self, mode='', name=None, pp=None, script=None, cat=None,
            output='plain', value = None, dummy=None, apikey = None):
        ...
        # An API Key is required (as well as the standard user/pass if set)
        # For accessing the api and other protected areas
        if not sabnzbd.NO_API_KEY:
            if not apikey:
                logging.warning("[%s] API Key missing, please enter the api key from config>general "
                                "into your 3rd party program:", __NAME__)
                return 'error: API Key Required'
            if sabnzbd.API_KEY != apikey:
        ...
        if mode == 'qstatus':
            ...
            if name and (name.isdigit() or len(name)==5):
                sabnzbd.add_msgid(name, pp, script, cat)
                return 'ok\n'
            else:
                return 'error\n'
            ...
            if name == 'speedlimit' or name == 'set_speedlimit': # http://localhost:8080/sabnzbd/api?mode=config&name=speedlimit&value=400
                ...
                sabnzbd.API_KEY = create_api_key()
                sabnzbd.CFG['misc']['api_key'] = sabnzbd.API_KEY
                return str(sabnzbd.API_KEY)
    ...
    @cherrypy.expose
    def scriptlog(self, name=None, dummy=None, session=None):
    ...
    @cherrypy.expose
    def retry(self, url=None, pp=None, cat=None, script=None, dummy=None, session=None):
...
class NzoPage(ProtectedClass):
    ...
    def bulk_operation(self, *args, **kwargs):
        msg = check_session(kwargs.get('session', None))
        if msg: return msg
    ...
    @cherrypy.expose
    def tog_verbose(self, dummy=None, session=None):
...
class QueuePage(ProtectedClass):
    ...
    @cherrypy.expose
    def index(self, dummy2=None, dummy=None, session=None):
        info, pnfo_list, bytespersec = build_header(self.__prim)
        ...
        for pnfo in pnfo_list:
            ...
            if self.__verbose or nzo_id in self.__verboseList:
                ...
                for tup in queued_files:
                    ...
                    line = {'filename':xml_name(fn), 'set':xml_name(_set),
                            'mbleft':"%.2f" % (bytes_left / MEBI),
                            'mb':"%.2f" % (bytes / MEBI),
                            'age':age}
                    queued.append(line)
    ...
    @cherrypy.expose
    def delete(self, uid = None, dummy=None, session=None):
        msg = check_session(session)
        if msg: return msg
    ...
    @cherrypy.expose
    def purge(self, dummy=None, session=None):
        msg = check_session(session)
        if msg: return msg
    ...
    @cherrypy.expose
    def removeNzf(self, nzo_id = None, nzf_id = None, dummy=None, session=None):
        msg = check_session(session)
        if msg: return msg
    ...
    @cherrypy.expose
    def tog_uid_verbose(self, uid, dummy=None, session=None):
        msg = check_session(session)
        if msg: return msg
    ...
    @cherrypy.expose
    def change_queue_complete_action(self, action = None, dummy=None, session=None):
        msg = check_session(session)
        if msg: return msg
    ...
    @cherrypy.expose
    def switch(self, uid1 = None, uid2 = None, dummy=None, session=None):
        msg = check_session(session)
        if msg: return msg
    ...
    @cherrypy.expose
    def change_opts(self, nzo_id = None, pp = None, dummy=None, session=None):
        msg = check_session(session)
        if msg: return msg
    ...
    @cherrypy.expose
    def change_script(self, nzo_id = None, script = None, dummy=None, session=None):
        msg = check_session(session)
        if msg: return msg
    ...
    @cherrypy.expose
    def change_cat(self, nzo_id = None, cat = None, dummy=None, session=None):
        msg = check_session(session)
        if msg: return msg
    ...
    @cherrypy.expose
    def sort_by_avg_age(self, dummy=None, session=None):
        msg = check_session(session)
        if msg: return msg
    ...
    @cherrypy.expose
    def sort_by_name(self, dummy=None, session=None):
        msg = check_session(session)
        if msg: return msg
    ...
    @cherrypy.expose
    def sort_by_size(self, dummy=None, session=None):
        msg = check_session(session)
        if msg: return msg
    ...
    @cherrypy.expose
    def set_speedlimit(self, dummy=None, value=None, session=None):
        msg = check_session(session)
        if msg: return msg
...
class HistoryPage(ProtectedClass):
    ...
    @cherrypy.expose
    def delete(self, job=None, dummy=None, session=None):
        msg = check_session(session)
        if msg: return msg
    ...
    @cherrypy.expose
    def reset(self, dummy=None, session=None):
        msg = check_session(session)
        if msg: return msg
    ...
    @cherrypy.expose
    def scriptlog(self, name=None, dummy=None, session=None):
        # Don't check session key, this will break old history links
...
class ConfigPage(ProtectedClass):
    ...
    @cherrypy.expose
    def restart(self, dummy=None, session=None):
        msg = check_session(session)
        if msg: return msg
...
class ConfigDirectories(ProtectedClass):
    ...
    def saveDirectories(self, download_dir = None, download_free = None, complete_dir = None, log_dir = None,
                        ...
                        dirscan_dir = None, dirscan_speed = None, script_dir = None, dummy=None, session=None):
        msg = check_session(session)
        if msg: return msg
...
class ConfigSwitches(ProtectedClass):
    ...
    def index(self, dummy=None, session=None):
        ...
        config['enable_par_multicore'] = IntConv(sabnzbd.CFG['misc']['enable_par_multicore'])
    ...
    def saveSwitches(self, par_option=None, enable_unrar = None, enable_unzip = None,
                     ...
                     script = None,
                     ionice=None, dummy=None, session = None,
                     enable_par_multicore=None
                     ):
        msg = check_session(session)
        if msg: return msg
        ...
        if enable_par_multicore:
            sabnzbd.CFG['misc']['enable_par_multicore'] = IntConv(enable_par_multicore)
        else:
            sabnzbd.CFG['misc']['enable_par_multicore'] = 0
...
class ConfigGeneral(ProtectedClass):
    ...
    def index(self, dummy=None, session=None):
        ...
        config['disable_key'] = sabnzbd.NO_API_KEY
    ...
    def saveGeneral(self, host = None, port = None, web_username = None, web_password = None, web_dir = None,
                    ...
                    cronlines = None, refresh_rate = None, rss_rate = None, disable_key=None,
                    bandwith_limit = None, cleanup_list = None, cache_limitstr = None, dummy=None, session=None):
        msg = check_session(session)
        if msg: return msg
        ...
        sabnzbd.CFG['misc']['disable_api_key'] = disable_key

        return saveAndRestart(self.__root, dummy)

    @cherrypy.expose
    def generateAPIKey(self, dummy=None, session=None):
        msg = check_session(session)
        if msg: return msg

        logging.debug('[%s] API Key Changed', __NAME__)
        sabnzbd.API_KEY = create_api_key()
        sabnzbd.CFG['misc']['api_key'] = sabnzbd.API_KEY
        raise Raiser(self.__root, dummy)
...
class ConfigServer(ProtectedClass):
    ...
    def addServer(self, server = None, host = None, port = None, timeout = None, username = None,
                         password = None, connections = None, ssl = None, fillserver = None, dummy=None, session=None):
        msg = check_session(session)
        if msg: return msg
    ...
    def saveServer(self, server = None, host = None, port = None, username = None, timeout = None,
                         password = None, connections = None, fillserver = None, ssl = None, dummy=None, session=None):
        msg = check_session(session)
        if msg: return msg
...
class ConfigRss(ProtectedClass):
    ...
    @cherrypy.expose
    def upd_rss_feed(self, feed=None, uri=None, cat=None, pp=None, script=None, enable=None, dummy=None, session=None):
        msg = check_session(session)
        if msg: return msg
    ...
    @cherrypy.expose
    def toggle_rss_feed(self, feed=None, uri=None, cat=None, pp=None, script=None, enable=None, dummy=None, session=None):
        msg = check_session(session)
        if msg: return msg
    ...
    @cherrypy.expose
    def add_rss_feed(self, feed=None, uri=None, dummy=None, session=None):
        msg = check_session(session)
        if msg: return msg
    ...
    def upd_rss_filter(self, feed=None, index=None, filter_text=None,
                       filter_type=None, cat=None, pp=None, script=None, dummy=None, session=None):
        msg = check_session(session)
        if msg: return msg
    ...
    @cherrypy.expose
    def pos_rss_filter(self, feed=None, current=None, new=None, dummy=None, session=None):
        msg = check_session(session)
        if msg: return msg
    ...
    @cherrypy.expose
    def del_rss_filter(self, feed=None, index=None, dummy=None, session=None):
        # Skip session check, too difficult to implement in skin
        # and fairly innocent
        # msg = check_session(session)
        # if msg: return msg
    ...
    @cherrypy.expose
    def rss_download(self, feed=None, id=None, cat=None, pp=None, script=None, dummy=None, session=None):
        msg = check_session(session)
        if msg: return msg
...
class ConfigScheduling(ProtectedClass):
    ...
    def addSchedule(self, minute = None, hour = None, dayofweek = None,
                    action = None, arguments = None, dummy=None, session=None):
        msg = check_session(session)
        if msg: return msg
    ...
    @cherrypy.expose
    def delSchedule(self, line = None, dummy=None, session=None):
        msg = check_session(session)
        if msg: return msg
...
class ConfigNewzbin(ProtectedClass):
    ...
    def saveNewzbin(self, username_newzbin = None, password_newzbin = None,
                    ...
                    newzbin_unbookmark = None, bookmark_rate = None, dummy=None, session=None):
        msg = check_session(session)
        if msg: return msg
    ...
    @cherrypy.expose
    def getBookmarks(self, dummy=None, session=None):
        msg = check_session(session)
        if msg: return msg
    ...
    @cherrypy.expose
    def showBookmarks(self, dummy=None, session=None):
        msg = check_session(session)
        if msg: return msg
    ...
    @cherrypy.expose
    def hideBookmarks(self, dummy=None, session=None):
        msg = check_session(session)
        if msg: return msg
...
class ConfigCats(ProtectedClass):
    ...
    @cherrypy.expose
    def delete(self, name = None, dummy=None, session=None):
        msg = check_session(session)
        if msg: return msg
    ...
    @cherrypy.expose
    def save(self, name=None, newname=None, pp=None, script=None, dir=None, newzbin=None, dummy=None, session=None):
        msg = check_session(session)
        if msg: return msg
    ...
    @cherrypy.expose
    def init_newzbin(self, dummy=None, session=None):
        msg = check_session(session)
        if msg: return msg
...
class ConnectionInfo(ProtectedClass):
    ...
    @cherrypy.expose
    def disconnect(self, dummy=None, session=None):
        msg = check_session(session)
        if msg: return msg
    ...
    @cherrypy.expose
    def testmail(self, dummy=None, session=None):
        msg = check_session(session)
        if msg: return msg
    ...
    @cherrypy.expose
    def clearwarnings(self, dummy=None, session=None):
        msg = check_session(session)
        if msg: return msg
    ...
    @cherrypy.expose
    def change_loglevel(self, loglevel=None, dummy=None, session=None):
        msg = check_session(session)
        if msg: return msg
...
def build_header(prim):
    ...
    # Use the api key as an embeded session id to try and prevent any XSS
    header['session'] = str(sabnzbd.API_KEY)
...
class ConfigEmail(ProtectedClass):
    ...
    def saveEmail(self, email_server = None, email_to = None, email_from = None,
                  ...
                  email_endjob = None, email_full = None, dummy=None, session=None):
